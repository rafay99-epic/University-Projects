    ...
    <body>
        <div>
            ...
            <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="mailto:99marafay@gmail.com">Life Style</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Mohammad Abdul Rafay and His Team.</p>
               </center>
               </div>
           </footer>
        </div>
